...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomePage(title: 'Flutter Demo Home Page', camera: camera),
    );
  }
}

class HomePage extends StatefulWidget {
  HomePage({Key? key, required this.title, required this.camera})
      : super(key: key);
  final String title;
  final CameraDescription camera;
        ...
        body: FutureBuilder(
            ...
            builder: (BuildContext context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                return MyCaremaPreview(cameraCtrl, refresh: refreshCameraCtrl);
...
class MyCaremaPreview extends StatefulWidget {
  MyCaremaPreview(this.cameraCtrl, {this.refresh});
  final CameraController cameraCtrl;
  final Function? refresh;
  @override
  _MyCameraPreview createState() => _MyCameraPreview();
}

class _MyCameraPreview extends State<MyCaremaPreview> {
  ...
  Future _stopDetect() async {
    if (mounted && widget.cameraCtrl != null) {
